...
class SearchNotificationBottomSheet extends StatefulWidget {
  const SearchNotificationBottomSheet({Key? key}) : super(key: key);

  @override
  State<SearchNotificationBottomSheet> createState() =>
      _SearchNotificationBottomSheetState();
}

class _SearchNotificationBottomSheetState
    extends State<SearchNotificationBottomSheet> {
